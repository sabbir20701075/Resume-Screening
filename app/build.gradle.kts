...
android {
    ...
    apollo {
        service("countries") {
            sourceFolder.set("com/example/resumescreening")
            rootPackageName.set("com.example.resumescreening")
            schemaFile.set(file("src/main/graphql/com/example/resumescreening/schema.graphqls"))
            introspection {
